...
if len(sys.argv) != 6:
    print("Usage: python attack-tcp.py iface srcMAC gatewayMAC srcIP:sport-range dstIP:dport")
    print("E.g. python attack-tcp.py eth0 aa:bb:dd:99:88:77 aa:bb:cc:00:11:22 1.2.3.4:1024-65535 80.100.131.150:80") # 'DELETE / HTTP/1.0\\n\\n'")
